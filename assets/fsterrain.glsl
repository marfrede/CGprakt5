...
void main()
{
    ...
    // vec3 AmbientColorNew = AmbientColor;
    // AmbientColorNew.y = Position.y / 2.0f;
    // AmbientColorNew.x = Position.y;
    // FragColor = vec4(((DiffuseComponent + AmbientColorNew) + SpecularComponent),1);
}
